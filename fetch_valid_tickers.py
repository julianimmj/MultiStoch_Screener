...
RAW_TICKERS = [
    "BRAV3", "ALPA4", "ABEV3", "AMBP3", "AZZA3", "ASAI3", "AZUL3", "B3SA3", 
    "BBSE3", "BBDC3", "BBDC4", "BRAP4", "BBAS3", "BRKM5", "MBRF3", "BPAC11", 
    "MOTV3", "CMIG4", "COGN3", "CPLE3", "CSAN3", "CPFE3", 
    "CMIN3", "CVCB3", "CYRE3", "DXCO3", "AXIA3", "AXIA6", "EMBJ3", "ENGI11", 
    "ENEV3", "EGIE3", "EQTL3", "EZTC3", "FLRY3", "GGBR4", "GOAU4", 
    "NATU3", "HAPV3", "HYPE3", "IGTI11", "IRBR3", "ITSA4", "ITUB4", 
    "JBSS32", "JHSF3", "KLBN11", "RENT3", "LWSA3", "LREN3", "MGLU3", 
    "CASH3", "BEEF3", "MRVE3", "MULT3", "PCAR3", "PETR3", "PETR4", "PRIO3", 
    "AUAU3", "RADL3", "RAIZ4", "RDOR3", "RAIL3", "SBSP3", "SANB11", "SMTO3", 
    "CSNA3", "SLCE3", "SUZB3", "TAEE11", "VIVT3", "TIMS3", "TOTS3", "UGPA3", 
    "USIM5", "VALE3", "VIIA3", "VBBR3", "WEGE3", "YDUQ3", "AERI3", 
    "ALUP11", "ANIM3", "ARML3", "BMOB3", "BRSR6", "CBAV3", "CEAB3", 
    "CSMG3", "CSED3", "DIRR3", "ECOR3", "ENAT3", "ESPA3", "EVEN3", "FESA4", 
    "GFSA3", "GGPS3", "GRND3", "RIAA3", "HBOR3", "HBSA3", "INTB3", "ISIS3", 
    "JALL3", "KEPL3", "LAVV3", "LOGG3", "LOGN3", "LUPA3", "MATD3", "MDIA3", 
    "MEAL3", "MOVI3", "MTRE3", "MYPK3", "NEOE3", "NGRD3", "SAUD3", "ONCO3", 
    "PARD3", "PGMN3", "PLPL3", "PNVL3", "POMO4", "PORP4", "POSI3", "PTBL3", 
    "QUAL3", "RANI3", "RAPT4", "RCSL3", "ROMI3", "SBFG3", "SEQL3", "SIMH3", 
    "SQIA3", "SYNE3", "TCSA3", "TEND3", "TGMA3", "TRIS3", "ISAE4", 
